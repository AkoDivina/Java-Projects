...
//     using it as aslist as required
...
//        using it as aslist as required
        ...
        list2 = null; // release resources  // list 2 is no longer needed, all its elements been sent to list 1
        printList(list1); // print list1 elements

        System.out.printf("%n upper case list 1");
